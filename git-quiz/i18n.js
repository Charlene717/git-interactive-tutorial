/* Git / GitHub Quiz · i18n
 * Same logic as ../i18n.js:
 * - localStorage key 'git_lang'（與教學共用，切換能跨頁同步）
...
(function(){
  ...
  const STR = {
    appTitle:        { zh:"🌿 Git / GitHub 互動考題", en:"🌿 Git / GitHub Interactive Quiz" },
    ...
    rangeAll:        { zh:"全部 12 個模組", en:"All 12 modules" },
    ...
    quizAllChapters: { zh:"Git / GitHub 互動考題（全部章節）", en:"Git / GitHub Interactive Quiz (All Chapters)" },
    quizErrataTitle: { zh:"Git / GitHub 互動考題", en:"Git / GitHub Interactive Quiz" },
